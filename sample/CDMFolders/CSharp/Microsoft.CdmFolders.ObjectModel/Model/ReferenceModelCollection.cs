// <copyright file="ReferenceModelCollection.cs" company="Microsoft">
...
namespace Microsoft.CdmFolders.ObjectModel
{
    ...
    /// <summary>
    /// Defines a collection of <see cref="Reference"/> objects
    /// </summary>
    public class ReferenceModelCollection : ObjectCollection<ReferenceModel>
    {
        /// <summary>
        /// Validates that loaded <see cref="ReferenceModelCollection"/> is correct and can function.
        /// </summary>
