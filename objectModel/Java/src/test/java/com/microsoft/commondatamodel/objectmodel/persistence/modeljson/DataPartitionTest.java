...
public class DataPartitionTest extends ModelJsonTestBase {
  ...
  public void testModelJsonDataPartitionLocationConsistency() throws ExecutionException, InterruptedException, IOException {
    final String inputPath = TestHelper.getInputFolderPath(TESTS_SUBPATH, "testModelJsonDataPartitionLocationConsistency");
    ...
    final CdmCorpusDefinition cdmCorpus2 = this.getLocalCorpus(inputPath);
    final CdmManifestDefinition manifestAfterConversion =
        ManifestPersistence.fromData
            (cdmCorpus2.getCtx(),
    ...
    final CdmCorpusDefinition cdmCorpus3 = this.getLocalCorpus(inputPath);
