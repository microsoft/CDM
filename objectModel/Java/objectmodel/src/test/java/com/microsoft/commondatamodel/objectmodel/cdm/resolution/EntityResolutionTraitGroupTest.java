 ...
 */
public class EntityResolutionTraitGroupTest {
    private static final String TESTS_SUBPATH = new File(new File(new File("Cdm"), "Resolution"), "EntityResolutionTest").toString();
