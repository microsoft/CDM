...
class CopyResourcesCommand(distutils.cmd.Command):
    ...
    def run(self):
        ...
        self.copy_and_overwrite('{}/../CDM.SchemaDocuments/'.format(root_path), '{}/resources/'.format(root_path), paths_to_ignore)
...
setuptools.setup(
    ...
    data_files=[
        ...
        ('resources/ODI-analogs', list_files_in_folder(['resources', 'ODI-analogs'])),
        ('resources/ODI-analogs/customer', list_files_in_folder(['resources', 'ODI-analogs', 'customer']))
    ],
    classifiers=[
