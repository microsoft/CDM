...
class LocalStorageAdapterTestCase(unittest.TestCase):
    ...
    def test_make_corpus_path(self, mock_abspath):
        ...
        # Absolute root path.
        adapter = LocalAdapter(root='/dir1')
        self.assertEqual(adapter.create_corpus_path(os.path.join('/dir1', 'dir2', 'dir3', 'file.json')), '/dir2/dir3/file.json')  # Absolute path.
        self.assertEqual(adapter.create_corpus_path(os.path.join('dir3', 'file.json')), '/dir2/dir3/file.json')  # Relative path.
        self.assertIsNone(adapter.create_corpus_path(os.path.join('/dir4', 'dir5', 'file.json')))  # Unrecognized path.

        # Non-absolute root path.
        adapter = LocalAdapter(root='dir3')
        self.assertEqual(adapter.create_corpus_path(os.path.join('/dir1', 'dir2', 'dir3', 'dir4', 'file.json')), '/dir4/file.json')  # Absolute path.
        self.assertEqual(adapter.create_corpus_path(os.path.join('dir3', 'dir4', 'file.json')), '/dir4/file.json')  # Relative path.
        self.assertIsNone(adapter.create_corpus_path(os.path.join('dir5', 'dir6', 'file.json')))  # Unrecognized path.

        # No root path.
        adapter = LocalAdapter()
        self.assertEqual(adapter.create_corpus_path(os.path.join('/dir1', 'dir2', 'dir5', 'dir6', 'file.json')), '/dir5/dir6/file.json')
        self.assertEqual(adapter.create_corpus_path(os.path.join('/dir1', 'dir2', 'file.json')), '/file.json')
    ...
    async def test_read(self, mock_abspath, mock_open):
        ...
        mock_open.assert_called_once_with(os.path.join('dir1', 'dir2', 'dir3', 'dir4', 'dir5', 'dir6', 'file.json'), 'r', encoding='utf-8')  # Verify file path.
    ...
    async def test_write(self, mock_abspath, mock_open):
        ...
        mock_open.assert_called_once_with(os.path.join('dir1', 'dir2', 'dir3', 'dir4', 'dir5', 'dir6', 'file.json'), 'w', encoding='utf-8')  # Verify file path.
