...
model_json_root = './tests/testdata/persistence/modeljson/test_from_and_to_data/test_input'
...
new_entity = new_entity_doc.definitions.append(name='NewEntity', of_type=CdmObjectType.ENTITY_DEF)  # type: CdmEntityDefinition
...
task = loop.create_task(manifest.save_as_async('model.json', save_referenced=True))
