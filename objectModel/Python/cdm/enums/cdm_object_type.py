...
class CdmObjectType(IntEnum):
    ...
    OPERATION_ADD_COUNT_ATTRIBUTE_DEF = 31
    OPERATION_ADD_SUPPORTING_ATTRIBUTE_DEF = 32
    OPERATION_ADD_TYPE_ATTRIBUTE_DEF = 33
    OPERATION_EXCLUDE_ATTRIBUTES_DEF = 34
    OPERATION_ARRAY_EXPANSION_DEF = 35
    OPERATION_COMBINE_ATTRIBUTES_DEF = 36
    OPERATION_RENAME_ATTRIBUTES_DEF = 37
    OPERATION_REPLACE_AS_FOREIGN_KEY_DEF = 38
    OPERATION_INCLUDE_ATTRIBUTES_DEF = 39
    OPERATION_ADD_ATTRIBUTE_GROUP_DEF = 40
    PROJECTION_DEF = 41
