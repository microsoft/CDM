...
class TypeAttributePersistence:
    ...
    def from_data(ctx: CdmCorpusContext, obj: DataColumn,
        ...
        if obj.origin_data_type_name.length > 0 and type_attribute.data_format == CdmDataFormat.STRING:
            type_attribute.data_format = CdmDataFormat.GUID
        ...
        if obj.origin_data_type_name.scale != 0 or obj.origin_data_type_name.precision != 0:
            ...
            scale_traits_arg = ctx.corpus.make_ref(CdmObjectType.ARGUMENT_DEF, "scale")
            scale_traits_arg.Value = obj.origin_data_type_name.scale
            numeric_traits.arguments.append(scale_traits_arg)
        
            precision_traits_arg = ctx.corpus.make_ref(CdmObjectType.ARGUMENT_DEF, "scale")
