...
class resolveContext {
    ...
    resolveString(ctx, str, avoid) {
        //let bodyCode = () =>
        {
            let seek = this.declarations.get(str);
...
class Document extends cdmObjectSimple {
    ...
    resolveString(ctx, str, avoid) {
        //let bodyCode = () =>
        {
            ...
            avoid.add(docPath);
            // in current document?
            let found = this.defaultContext.resolveString(ctx, str, avoid);
...
class Corpus extends Folder {
    ...
    ////////////////////////////////////////////////////////////////////////////////////////////////////
    ////////////////////////////////////////////////////////////////////////////////////////////////////
    static declareObjectDefinitions(ctx, obj, relativePath, resCtx) {
        //let bodyCode = () =>
        {
            obj.visit(relativePath, (iObject, path, statusRpt) => {
                ...
                switch (iObject.objectType) {
                    ...
                    case cdmObjectType.entityDef:
                        ...
                        resCtx.declarations.set(path, iObject);
                    ...
                    if (dt.isDerivedFrom("cdmObject")) {
                        ...
                        if (typeof (pValue) === "string") {
                            ...
                            if (foundDesc == "this.attribute" && expected == "attribute") {
                                ...
                                replacement.resolvedReference = ctx.currentScope.currentAtttribute;
                                ...
                                if (seekResAtt >= 0) {
                                    ...
                                    let ent = ctx.currentScope.resolver.resolveString(ctx, entName, new Set());
                                    ...
                                    replacement = ctx.currentScope.resolver.resolveString(ctx, pValue, new Set());
                                    if (replacement) {
                                        foundType = ctx.expectedType = replacement.objectType;
                                    }
                                }
                            }
                        }
    ...
    resolveReferencesAndValidate(stage, status, errorLevel = cdmStatusLevel.warning) {
        //let bodyCode = () =>
        {
            return new Promise(resolve => {
                let errors = 0;
                let ctx = new resolveContextScopeStack(this.allDocuments[0]["1"], this.statusLevel, (level, msg, path) => { if (level >= errorLevel)
